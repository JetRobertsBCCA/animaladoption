...
const AnimalListings = () => {
  ...
  const handleUpdate = async (animalId, updatedAnimalData) => {
    try {
      ...
      const currentAnimalResponse = await fetch(`https://unit-4-project-app-24d5eea30b23.herokuapp.com/get/${animalId}?teamId=1`);
      ...
      const currentAnimalData = currentAnimal.data_json.body || currentAnimal.data_json; // Handle potential nesting
      const updatedAnimal = {
        id: animalId,
        team: 1,
        ...
        description: currentAnimalData.description || updatedAnimalData.description,
    ...
    <div className="listings-container">
      ...
      {animals.length === 0 ? (
        ...
        animals.map((animal) => {
          ...
          return (
            <div key={animal.id} className={`card ${animalData.isAdopted ? 'adopted' : ''}`}>
              ...
              <div className="card-content">
                ...
                <p className="card-info">Description: {animalData.description}</p>
